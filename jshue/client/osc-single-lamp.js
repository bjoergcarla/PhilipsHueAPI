...
node bridge.js
*/
//var lightNumber = prompt("Nummer På Lys");
var lightNumber = 26;
var lys = 0;
var varme = 0;
...
// Fælles brugernavn
var username = 'IJEMSjbPcKI2sNjsweFAlwOlgC6WNIspCbL8Ij6A';
//Slidere
var dimmer, temper;
...
function setup() {
    ...
    test = createButton("WAUW");
    test.position(10,70);
    test.mouseReleased(changexy);

    test2 = createButton("Yes!");
    test2.position(10,100);
    test2.mouseReleased(changexy);
